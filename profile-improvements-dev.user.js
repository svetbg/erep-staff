...
(function() {
    ...
    $( document ).ready(function() {
        ...
        var numOfHits = parseInt($('input#number-of-hits'))||1
        var oneHit = 0
        ...
        $('div.vs164-11').after('<h3 style="margin-top: 15px;clear: both;"><span>Calculator</span></h3><br /><div class="vs165 hits"><div id="oneHit" class="vs165-1"> NE: <input type="checkbox" id="ne" value="1.1"/> <select required="required" class="form-control" id="weapon"><option value="1.0">No weapon</option><option value="1.2">Q1 Weapon</option><option value="1.4">Q2 Weapon</option><option value="1.6">Q3 Weapon</option><option value="1.8">Q4 Weapon</option><option value="2.0">Q5 Weapon</option><option value="1.4">Q1 Tank</option><option value="1.8">Q2 Tank</option><option value="2.2">Q3 Tank</option><option value="2.6">Q4 Tank</option><option value="3.0">Q5 Tank</option><option value="2.4">Q1 Helicopter</option><option value="2.6">Q2 Helicopter</option><option value="3.0">Q3 Helicopter</option><option value="3.5">Q4 Helicopter</option><option value="4.0">Q5 Helicopter</option><option value="5.0">RPG</option></select> <select required="required" class="form-control" id="dsystem"><option value="0.0">No Defense</option><option value="0.05">Q1 Defense</option><option value="0.10">Q2 Defense</option><option value="0.15">Q3 Defense</option><option value="0.20">Q4 Defense</option><option value="0.25">Q5 Defense</option></select> <select required="required" class="form-control" id="booster"><option value="1.0">No booster</option><option value="1.1">Q1 Booster</option><option value="1.3">Q3 Booster</option><option value="1.5">Q5 Booster</option></select></div> <div class="vs165-3"><span id="oneHit hit-class">'+(oneHit).toLocaleString(userLang, {minimumFractionDigits: 2})+'</span> / <input type="text" class="form-control small-number" name="number-of-hits" id="number-of-hits" value="1"/> hit(s)</div></div>')
